...
struct ImageListView: View {
    ...
    var body: some View {
        VStack {
            FiltersView(userLogin: userLogin, category: category, filterField: $filterField, sortByName: sortByName, loadImages: loadImages)
        ...
        .onAppear {
            ...
            // fetchImages()
            loadImages() // dziala asynchronicznie (na innym watku)
